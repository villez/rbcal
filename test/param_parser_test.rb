...
class ParamParserTest < Minitest::Test
  ...
  def test_default
    month_range = VsCal::ParamParser.parse_command_line_parameters([])
  ...
  def test_plus_month
    plus = 7
    month_range = VsCal::ParamParser.parse_command_line_parameters(["+#{plus}"])
  ...
  # vscal 2015  => full year, Jan-Dec 2015
  def test_full_year
    month_range = VsCal::ParamParser.parse_command_line_parameters(["2015"])
  ...
  def test_month_range_current_year
    month_range = VsCal::ParamParser.parse_command_line_parameters(["7-10"])
  ...
  def test_month_range_cross_year
    month_range = VsCal::ParamParser.parse_command_line_parameters(["10-5"])
  ...
  def test_single_month_with_year_space
    month_range = VsCal::ParamParser.parse_command_line_parameters(["05", "2014"])
  ...
  def test_single_month_with_year_slash
    month_range = VsCal::ParamParser.parse_command_line_parameters(["03/2015"])
  ...
  def test_month_range_with_year_space
    month_range = VsCal::ParamParser.parse_command_line_parameters(["10-12", "2013"])
  ...
  def test_month_range_with_year_slash
    month_range = VsCal::ParamParser.parse_command_line_parameters(["03-04/2016"])
  ...
  def test_month_range_with_years_spaces
    month_range = VsCal::ParamParser.parse_command_line_parameters(["10", "2013", "05", "2014"])
  ...
  def test_month_range_with_years_slash_space
    month_range = VsCal::ParamParser.parse_command_line_parameters(["11/2014", "10/2015"])
  ...
  def test_month_range_with_years_slash_dash
    month_range = VsCal::ParamParser.parse_command_line_parameters(["09/2014-02/2015"])
